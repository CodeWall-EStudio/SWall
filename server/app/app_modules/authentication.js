...
var GET_ENCODE_KEY_API      = {host:'my.71xiaoxue.com',     path:'/authenticationUser.do'},
    ...
    UC_ORGANIZATION_TREE    = {host:/* grunt|env:server.api.login.host */"szone.hylc-edu.cn"/* end */,  path:'/api/organization/tree'},
    UC_LOGIN_API            = {host:/* grunt|env:server.api.login.host */"szone.hylc-edu.cn"/* end */,  path:'/api/user/login'},
    UC_VERIFY_API           = {host:/* grunt|env:server.api.login.host */"szone.hylc-edu.cn"/* end */,  path:'/api/user/validate'};
