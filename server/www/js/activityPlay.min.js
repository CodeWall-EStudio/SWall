...
a.setSeconds(0);a.setMilliseconds(0);return a.getTime().toString()}a.activityList=[];a.activityMap={};a.selectedActivity=null;a.selectedActivityID="";a.hints="";return{selectActivity:p,selectActivityByID:function(c){p(a.activityMap[c])},fetchActivities:function(c,e,h){a.activityList=[];a.activityMap={};a.hints="\u8bf7\u7a0d\u5019...";c=c||{};"manager"==a.mode()&&(c.creator=n.uid());c._=(new Date).getTime();console.log("[ActivityService] fetching activities with",c);b.get(f+"/activities",{responseType:"json",
params:c}).success(function(c,b){if(200===b&&!c.c){var h=c.r.activities,g=_.groupBy(h,function(a){return d(a)});a.activityList=_.map(g,function(a,c){return{date:c,activities:a}});a.activityMap=_.reduce(h,function(a,c){a[c._id]=c;return a},{});a.hints=a.activityList.length?"":"\u6ca1\u627e\u5230\u4efb\u4f55\u6d3b\u52a8";console.log("[ActivityService] activities result",a.activityList,a.activityMap)}e&&e(c,b)}).error(function(c,b){a.hints="\u62c9\u53d6\u6d3b\u52a8\u5931\u8d25";h&&h(c,b)})},getActivity:function(a,
d,e){b.get(f+"/activities/"+a,{responseType:"json"}).success(d).error(e)},createActivity:function(c,l,h){c=g.object.toUrlencodedString(c);b.post(f+"/activities",c,{responseType:"json",headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(c,b){if(c&&!c.c&&c.r)a:{var h=c.r[0];a.activityMap[h._id]=h;for(var g=d(h),f=0;f<a.activityList.length;++f){var k=a.activityList[f];if(k.date==g){k.activities.unshift(h);break a}else if(k.date>g){e(f,h);break a}}e(f,h)}l&&l(c,b)}).error(h)},
updateActivity:k,closeActivity:function(a,b,d){k(a,{status:"closed"},b,d)},deleteActivity:function(a,b,d){},fetchActivityConfig:function(a,d){var e=(new Date).getTime();b.get(f+"/activities/config?_="+e,null,{responseType:"json"}).success(function(b,d){console.log("[ActivityService] activity config =",b);a&&a(b,d)}).error(function(a,b){console.error("[ActivityService] FAIL TO FETCH ACTIVITY CONFIGURATIONS");d&&d(a,b)})}}}]);angular.module("ap.controllers.main",["ts.services.activity","ts.services.user"]).controller("PlayerMainController",["$rootScope","$scope","$location","ActivityService","UserService",function(a,b,g,n,f){function p(){var b=g.search().aid;n.getActivity(b,function(b,c){console.log("[PlayerMainController] get activity success",c,b);if(200==c&&!b.c)if(a.activity=b.r,k(b.r),a.activity.active)a.userCount=a.activity.users.participators.length,setTimeout(function(){p()},5E3);else{var e=_.countBy(a.selectedActivity.resources,
