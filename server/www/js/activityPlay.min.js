...
f=new Date(a.selectedMainVideoStartTime()),a.selectedMainVideoStartDate={y:f.getFullYear(),M:f.getMonth()+1,d:f.getDate(),h:f.getHours(),m:f.getMinutes(),s:f.getSeconds()})};b.showResourceDetail=function(e,c,f){b.highlightSpecifyResource(e,c,f,!0);e.type&&(b.selectedResource=e,b.selectedRIndex=a.presources.indexOf(e))};b.highlightSpecifyResource=function(b,c,f,d){console.log("highlighting resource",c,f);a.highlightResource={g:c,r:f};b&&(c=$(".resourceItem[data-ts="+b.date+"]"),g(c,!0,!0));d&&a.selectedMainVideo&&
b&&(b=b.date,d=a.selectedMainVideoStartTime(),c=d+a.selectedMainVideo.duration,console.log(b,d,c),b<d?b=d:b>c&&(b=c),u.currentTime=b-d,u.play())};b.hasPreviousPreviewableResource=function(){return 0<b.selectedRIndex};b.hasNextPreviewableResource=function(){return b.selectedRIndex<a.presources.length-1};b.selectPreviousPreviewableResource=function(){0<b.selectedRIndex&&(--b.selectedRIndex,b.selectedResource=a.presources[b.selectedRIndex])};b.selectNextPreviewableResource=function(){b.selectedRIndex<
a.presources.length-1&&(++b.selectedRIndex,b.selectedResource=a.presources[b.selectedRIndex])};b.filterByUser=function(a){b.selectedUser=a;$(".resourceGroup").css("display","none");setTimeout(function(){$(".resourceGroup").css("display","-webkit-box");b.$digest();refreshAllNextItemLineHeight()},0)};b.nextLineHeight=function(b,a){if(a){var c=$('.resourceItem[data-gindex="'+b+'"][data-rindex="'+a+'"]').outerHeight();return c?c-3:0}return 0};b.isFirstResourceInGroup=function(b,a){if(0==a)return!0;var c=
document.querySelector('.resourceItem[data-gindex="'+b+'"][data-rindex="'+a+'"]');if(c){var d=c.parentElement.querySelectorAll(".resourceItem:not(.ng-hide)")[0];return c==d}return!1};b.resourceShouldBeVisible=function(a){return!b.selectedUser||b.selectedUser==a.user};b.groupContainsResourceOfSelectedUser=function(a){return b.selectedUser?_.some(a.resources,function(a){return a.user==b.selectedUser}):!0};b.hideResourceDetail=function(){b.selectedResource=null;b.selectedRIndex=-1};b.toggleAuthRefresh=
function(){b.autoRefresh=!b.autoRefresh;b.autoRefresh?l():h&&(clearTimeout(h),h=0)};b.showUserStatistics=function(){b.stat=2;var c=n.statistics.byUser(a.activity,10),c=_.map(c,function(b){return[a.uid2nick(b.uid),b.count]});c.splice(0,0,["\u7528\u6237","\u8d44\u6e90\u6570"]);var d=google.visualization.arrayToDataTable(c),f={is3D:!0},g=new google.visualization.PieChart(document.getElementById("statBody"));setTimeout(function(){g.draw(d,f)},200)};b.showTimeStatistics=function(){b.stat=1;var c=n.statistics.byTime(a.activity),
d=c.beginning,c=_.map(c.items,function(b,a){var c=new Date(parseInt(a)+d);return[c.getFullYear()+"-"+(c.getMonth()+1)+"-"+c.getDate()+" "+c.getHours()+":"+c.getMinutes(),b.length]});c.splice(0,0,["\u65f6\u95f4","\u8d44\u6e90\u6570"]);var f=google.visualization.arrayToDataTable(c),g={hAxis:{title:"\u65f6\u95f4",titleTextStyle:{color:"red"}}},h=new google.visualization.ColumnChart(document.getElementById("statBody"));setTimeout(function(){h.draw(f,g)},200)};window.rs=a;window.utils=r;l();(function(){var b=
document.querySelector("video");b.addEventListener("timeupdate",function(d){d=a.selectedMainVideoStartTime()+1E3*b.currentTime;d=c(d);d=$(".resourceItem[data-ts="+d+"]");g(d,!0)})})()}]);document.domain="71xiaoxue.com";
