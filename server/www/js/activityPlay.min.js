...
-1};b.toggleAuthRefresh=function(){b.autoRefresh=!b.autoRefresh;b.autoRefresh?l():h&&(clearTimeout(h),h=0)};b.showUserStatistics=function(){b.stat=2;var c=n.statistics.byUser(a.activity,10),c=_.map(c,function(b){return{nick:a.uid2nick(b.uid),count:b.count}});console.log(c);AmCharts.makeChart("statBody",{type:"pie",theme:"light",dataProvider:c,valueField:"count",titleField:"nick"})};b.showTimeStatistics=function(){b.stat=1;var c=n.statistics.byTime(a.activity),d=c.beginning,c=_.map(c.items,function(b,
a){var c=new Date(parseInt(a)+d);return{date:c.getFullYear()+"-"+(c.getMonth()+1)+"-"+c.getDate()+" "+c.getHours()+":"+c.getMinutes(),count:b.length}});AmCharts.makeChart("statBody",{type:"serial",theme:"light",dataProvider:c,valueAxes:[{gridColor:"#FFFFFF",gridAlpha:0.2,dashLength:0,labelsEnabled:!1}],gridAboveGraphs:!0,startDuration:1,graphs:[{balloonText:"[[category]]: <b>[[value]]</b>",fillAlphas:0.8,lineAlpha:0.2,type:"column",valueField:"count"}],chartCursor:{categoryBalloonEnabled:!1,cursorAlpha:0,
zoomable:!1},categoryField:"date",categoryAxis:{gridPosition:"start",gridAlpha:0,labelRotation:45}})};window.rs=a;window.utils=r;l();(function(){var b=document.querySelector("video");b.addEventListener("timeupdate",function(d){d=a.selectedMainVideoStartTime()+1E3*b.currentTime;d=c(d);d=$(".resourceItem[data-ts="+d+"]");g(d,!0)})})()}]);document.domain="71xiaoxue.com";
