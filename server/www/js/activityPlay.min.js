...
d,b);if(200==d&&!b.c)if(a.activity=b.r,a.resources=_.groupBy(a.activity.resources,function(a){a=new Date(a.date);a.setSeconds(0);a.setMilliseconds(0);return a.getTime()}),a.presources=_.filter(a.activity.resources,function(a){return 1==a.type||2==a.type}),a.activity.active)a.userCount=a.activity.users.participators.length;else{var e=_.countBy(a.selectedActivity.resources,function(a){return a.user});a.userCount=_.keys(e).length}},function(a,b){console.error("[PlayerMainController] get activity fail",
b,a)});console.log("[PlayerMainController] getting info of activity "+b)})()}]);(function(){angular.module("activityPlay",["ts.services.user","ts.services.activity","ap.controllers.main"])})();
