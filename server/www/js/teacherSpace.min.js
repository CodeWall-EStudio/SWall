...
e.headTemplate+'<tbody></tbody></table></div><div class="datepicker-months"><table class="table-condensed">'+e.headTemplate+e.contTemplate+'</table></div><div class="datepicker-years"><table class="table-condensed">'+e.headTemplate+e.contTemplate+"</table></div></div>"}(window.jQuery);(function(){angular.module("TeacherSpace",[]).controller("MainController",["$rootScope","$scope","$http",function(c,d,e){c.uid="oscar";c.activityID="";c.activity=null;c.fetchActivities=function(a){a=a||{};a.uid=c.uid;e.get("/activities",{responseType:"json",params:a}).success(function(a,d){if(200===d&&!a.c){var e=a.r.activities,f=_.groupBy(e,function(a){var b=new Date(a.info.date);a=b.getFullYear();var c=b.getMonth()+1,b=b.getDate();return[a,c,b].join("_")});c.activityList=_.map(f,function(a,b){return{date:b,
activities:a}});c.activityMap=_.reduce(e,function(a,b){a[b._id]=b;return a},{})}}).error(function(a,c){})};c.fetchActivities()}]).controller("NavigatorController",["$rootScope","$scope",function(c,d){}]).controller("ToolbarController",["$rootScope","$scope",function(c,d){d.authorizationTypes=[{label:"\u6388\u6743\u6211\u53c2\u4e0e\u7684",value:"invited"},{label:"\u516c\u5f00\u7684",value:"public"},{label:"\u5168\u90e8",value:null}];d.statuses=[{label:"\u5f00\u653e\u7684",value:"active"},{label:"\u5173\u95ed\u7684",
value:"closed"},{label:"\u5168\u90e8",value:null}];d.aTypeIndex=2;d.statusIndex=2;d.searchKeyword="";d.updateQueryCondition=function(e,a){if(d[e]!==a){d[e]=a;var b={},n=d.authorizationTypes[d.aTypeIndex].value,l=d.statuses[d.statusIndex].value;n&&(b.authorize=n);l&&(b.status=l);d.searchKeyword&&(b.kw=d.searchKeyword);c.fetchActivities(b)}}}]).controller("ActivityListController",["$rootScope","$scope",function(c,d){d.selectActivity=function(d){c.activityID=d;c.activity=c.activityMap[d]}}]).controller("ActivityDetailController",
...
grade:d.grade,"class":d["class"],subject:d.subject,domain:d.domain};e.post("/activities",a,{responseType:"json"}).success(function(a,c){console.log(a,c)}).error(function(a,c){})}}]).directive("activityDate",function(){return{link:function(c,d,e){c=c.item.date.split("_");d.text(c[0]+"\u5e74"+c[1]+"\u6708"+c[2]+"\u65e5")}}}).directive("activityDatePicker",function(){return{link:function(c,d,e){var a=new Date,b=$(d).datepicker({onRender:function(b){return b.getTime()<a.getTime()?"disabled":""}}).on("changeDate",
function(a){b.hide();var d=e.dateModel;d&&(c[d]=a.date)}).data("datepicker")}}})})();
