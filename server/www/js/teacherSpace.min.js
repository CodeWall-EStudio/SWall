...
k={info:{type:1},users:{invitedUsers:[]}};"datetime-local"!=t.type&&$("#na_data").datetimePicker("setEndDate",null);b.$on(l,function(b,c){c=c||{};a.panelTitle=c.panelTitle||"\u521b\u5efa\u6d3b\u52a8";a.confirmBtnTitle=c.confirmBtnTitle||"\u521b\u5efa\u6d3b\u52a8";a.cancelBtnTitle=c.cancelBtnTitle||"\u53d6\u6d88";a.activity=c.activity||$.extend(!0,{},k);a.invitedUsers=a.activity.users.invitedUsers.join(",");for(var f=a.config?a.config.activityConfig:{},e=a.activity.info,h=0;h<f.classes.length;++h){var l=
f.classes[h];if(l.grade==e.grade){a.grade=h;a.cls=l.cls.indexOf(e["class"]);console.log(a.grade,a.cls);break}}e=a.activity.info.date;f=new Date;e=e?new Date(e):f;e.setSeconds(0);e.setMilliseconds(0);a.activity.info.date=d.time.dateToDatetimePickerValue(e);t.setAttribute("min",d.time.dateToDatetimePickerValue(f));_.each(a.activity.users.invitedUsers,function(a){q.tagsinput("add",a)});a.showActivityPanel()});p.on("hidden.bs.modal",function(){a.activity=$.extend(!0,{},k);a.grade=a.cls=a.subject=0;a.errMsg=
"";q.tagsinput("removeAll")});a.$watch("grade",function(a){});a.showActivityPanel=function(){$("#createActivityModal").modal("show");!a.activity._id||a.activity.active?e.removeAttribute("disabled"):e.setAttribute("disabled","disabled")};a.createActivity=function(){a.errMsg="";m();var b=a.config?a.config.activityConfig:{},c=b.classes[a.grade],b=b.subjects[a.subject],c={uids:a.invitedUsers||"",title:a.activity.info.title||"",type:a.activity.info.type|1,desc:a.activity.info.desc||"",date:d.time.datetimePickerValueToTs(a.activity.info.date),
teacher:a.activity.info.teacher||"",grade:c?c.grade:"","class":c?c.cls[a.cls]:"",subject:b||"",domain:a.activity.info.domain||""};h.createActivity(c,f,n)};a.updateActivity=function(){a.errMsg="";m();var b=a.config?a.config.activityConfig:{},c={uids:a.invitedUsers||""};a.activity.active&&(c.title=a.activity.info.title||"",c.type=a.activity.info.type||"",c.desc=a.activity.info.desc||"",c.date=d.time.datetimePickerValueToTs(a.activity.info.date),c.teacher=a.activity.info.teacher||"",c.grade=b.classes[a.grade].grade||
"",c["class"]=b.classes[a.grade].cls[a.cls]||"",c.subject=b.subjects[a.subject]||"",c.domain=a.activity.info.domain||"");h.updateActivity(a.activity._id,c,f,n)};a.handleConfirmBtnClick=function(){a.activity._id?a.updateActivity():a.createActivity()};(function(){h.fetchActivityConfig(function(b,c){a.config=b})})()}]);angular.module("ts.controllers.loginForm",["ts.utils.constants","ts.services.user"]).controller("LoginFormController",["$rootScope","$scope","UserService","CMD_SHOW_LOGIN_PANEL",function(b,a,c,h){a.uid="";a.pwd="";a.errMsg="";a.login=function(){function b(c,d){200==d?$("#loginModal").modal("hide"):(a.errMsg="\u9a8c\u8bc1\u5931\u8d25",a.$digest());a.uid=a.pwd=a.errMsg=""}a.uid?a.pwd?c.login(a.uid,a.pwd,b,b):a.errMsg="\u8bf7\u8f93\u5165\u5bc6\u7801":a.errMsg="\u8bf7\u8f93\u5165\u5e10\u53f7\u540d"};
b.$on(h,function(){if(c.hasLoggedIn())if(confirm("\u786e\u5b9a\u8981\u9000\u51fa\u767b\u5f55\u5417\uff1f"))c.logout();else return;$("#loginModal").modal("show")})}]);angular.module("ts.controllers.main",["ts.utils.constants","ts.services.user","ts.services.activity"]).controller("MainController",["$rootScope","$scope","$http","$location","UserService","ActivityService","EVENT_LOGIN","CMD_SHOW_LOGIN_PANEL","EVENT_MODE_CHANGE",function(b,a,c,h,d,l,f,n,m){b.fetchActivities=function(a){l.selectActivity();l.fetchActivities(a)};b.showLoginModal=function(){b.$emit(n)};b.mode=function(){return h.search().mode};b.gotoMode=function(a){a!==b.mode()&&(h.search("mode",a),
