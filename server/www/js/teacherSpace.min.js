...
c.closeActivity(b.selectedActivity._id)};a.deleteActivity=function(){confirm("\u78ba\u5b9a\u8981\u522a\u9664\u6d3b\u52d5\uff1f")&&c.deleteActivity(b.selectedActivity._id)};a.handlePlayBtnClick=function(){window.open("activity_play.html#?aid="+b.selectedActivity._id,"_blank")};b.$on(h,function(a,b){c.selectActivity()})}]);angular.module("ts.controllers.activityList",["ts.services.activity"]).controller("ActivityListController",["$rootScope","$scope","ActivityService",function(b,a,c){a.selectActivity=function(a){c.selectActivityByID(a)}}]);angular.module("ts.controllers.activityPanel",["ts.utils.constants","ts.services.activity","ts.services.utils"]).controller("ActivityPanelController",["$rootScope","$scope","$http","ActivityService","UtilsService","CMD_SHOW_ACTIVITY_PANEL",function(b,a,c,h,d,l){function f(a,b){console.log(a,b);s.removeAttribute("disabled");p.modal("hide")}function n(b,c){b=b||{c:-1,msg:"UNKNOWN"};a.errMsg=c+" - ["+b.c+"] "+b.m;s.removeAttribute("disabled")}function m(){s.setAttribute("disabled","disabled")}var p=
$("#createActivityModal"),q=$('input[data-role="tagsinput"]'),t=document.getElementById("na_date"),s=document.getElementById("activityFormAllFields"),e=document.getElementById("activityFormFieldsForOpenActivities"),k={info:{type:1},users:{invitedUsers:[]}};b.$on(l,function(b,c){c=c||{};a.panelTitle=c.panelTitle||"\u521b\u5efa\u6d3b\u52a8";a.confirmBtnTitle=c.confirmBtnTitle||"\u521b\u5efa\u6d3b\u52a8";a.cancelBtnTitle=c.cancelBtnTitle||"\u53d6\u6d88";a.activity=c.activity||$.extend(!0,{},k);a.invitedUsers=
a.activity.users.invitedUsers.join(",");for(var f=a.config?a.config.activityConfig:{},e=a.activity.info,h=0;h<f.classes.length;++h){var l=f.classes[h];if(l.grade==e.grade){a.grade=h;a.cls=l.cls.indexOf(e["class"]);console.log(a.grade,a.cls);break}}e=a.activity.info.date;f=new Date;e=e?new Date(e):f;e.setSeconds(0);e.setMilliseconds(0);a.activity.info.date=d.time.dateToDatetimePickerValue(e);t.setAttribute("min",d.time.dateToDatetimePickerValue(f));_.each(a.activity.users.invitedUsers,function(a){q.tagsinput("add",
...
title:a.activity.info.title||"",type:a.activity.info.type|1,desc:a.activity.info.desc||"",date:d.time.datetimePickerValueToTs(a.activity.info.date),teacher:a.activity.info.teacher||"",grade:b.classes[a.grade].grade,"class":b.classes[a.grade].cls[a.cls],subject:b.subjects[a.subject],domain:a.activity.info.domain||""};h.createActivity(b,f,n)};a.updateActivity=function(){a.errMsg="";m();var b=a.config?a.config.activityConfig:{},c={uids:a.invitedUsers||""};a.activity.active&&(c.title=a.activity.info.title||
"",c.type=a.activity.info.type||"",c.desc=a.activity.info.desc||"",c.date=d.time.datetimePickerValueToTs(a.activity.info.date),c.teacher=a.activity.info.teacher||"",c.grade=b.classes[a.grade].grade||"",c["class"]=b.classes[a.grade].cls[a.cls]||"",c.subject=b.subjects[a.subject]||"",c.domain=a.activity.info.domain||"");h.updateActivity(a.activity._id,c,f,n)};a.handleConfirmBtnClick=function(){a.activity._id?a.updateActivity():a.createActivity()};(function(){h.fetchActivityConfig(function(b,c){a.config=
b})})()}]);angular.module("ts.controllers.loginForm",["ts.utils.constants","ts.services.user"]).controller("LoginFormController",["$rootScope","$scope","UserService","CMD_SHOW_LOGIN_PANEL",function(b,a,c,h){a.uid="";a.pwd="";a.errMsg="";a.login=function(){function b(c,d){200==d?$("#loginModal").modal("hide"):(a.errMsg="\u9a8c\u8bc1\u5931\u8d25",a.$digest());a.uid=a.pwd=a.errMsg=""}a.uid?a.pwd?c.login(a.uid,a.pwd,b,b):a.errMsg="\u8bf7\u8f93\u5165\u5bc6\u7801":a.errMsg="\u8bf7\u8f93\u5165\u5e10\u53f7\u540d"};
b.$on(h,function(){if(c.hasLoggedIn())if(confirm("\u786e\u5b9a\u8981\u9000\u51fa\u767b\u5f55\u5417\uff1f"))c.logout();else return;$("#loginModal").modal("show")});c.hasLoggedIn()||$("#loginModal").modal("show")}]);angular.module("ts.controllers.main",["ts.utils.constants","ts.services.user","ts.services.activity"]).controller("MainController",["$rootScope","$scope","$http","$location","UserService","ActivityService","EVENT_LOGIN","CMD_SHOW_LOGIN_PANEL","EVENT_MODE_CHANGE",function(b,a,c,h,d,l,f,n,m){b.fetchActivities=function(a){l.selectActivity();l.fetchActivities(a)};b.showLoginModal=function(){b.$emit(n)};b.mode=function(){return h.search().mode};b.gotoMode=function(a){a!==b.mode()&&(h.search("mode",a),
b.$emit(m,a))};b.$on(f,function(a,c){200==c&&b.fetchActivities()});d.hasLoggedIn()&&b.fetchActivities()}]);angular.module("ts.controllers.navigator",["ts.services.user"]).controller("NavigatorController",["$rootScope","$scope","UserService","EVENT_LOGIN","CMD_SHOW_LOGIN_PANEL",function(b,a,c,h,d){b.$on(h,function(b,d){200==d&&(a.nickname=c.nick())});a.nickname=c.nick()}]);angular.module("ts.controllers.toolbar",["ts.utils.constants"]).controller("ToolbarController",["$rootScope","$scope","EVENT_MODE_CHANGE","CMD_SHOW_ACTIVITY_PANEL",function(b,a,c,h){a.authorizationTypes=[{label:"\u6388\u6743\u6211\u53c2\u4e0e\u7684",value:"invited"},{label:"\u516c\u5f00\u7684",value:"public"},{label:"\u5168\u90e8",value:null}];a.statuses=[{label:"\u5f00\u653e\u7684",value:"active"},{label:"\u5173\u95ed\u7684",value:"closed"},{label:"\u5168\u90e8",value:null}];a.aTypeIndex=2;a.statusIndex=
2;a.searchKeyword="";a.showCreateActivityModal=function(a){a.currentTarget.classList.contains("disabled")||b.$emit(h)};a.updateQueryAndSearch=function(c,h){c&&(a[c]=h);var f={},n=a.authorizationTypes[a.aTypeIndex].value,m=a.statuses[a.statusIndex].value;n&&(f.authorize=n);m&&(f.status=m);a.searchKeyword&&(f.kw=a.searchKeyword);b.fetchActivities(f)};b.$on(c,function(b,c){a.updateQueryAndSearch()})}]);angular.module("ts.directives.ngEnter",[]).directive("ngEnter",function(){return{link:function(b,a,c){a.on("keydown",function(a){if(13==a.keyCode){var d=c.ngEnter;d&&_.bind(function(){eval("this."+d)},b)()}})}}});(function(){angular.module("teacherSpace","ts.controllers.main ts.controllers.navigator ts.controllers.toolbar ts.controllers.activityList ts.controllers.activityDetail ts.controllers.activityPanel ts.controllers.loginForm ts.directives.ngEnter".split(" "))})();
