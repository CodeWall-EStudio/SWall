...
a,d,document.cookie);200==d&&n?(localStorage.login_result=JSON.stringify(a),n(a,d)):p&&p(a,d);b.$emit(f,d,a)}a.put(k+"/users/"+e+"/login","pwd="+encodeURIComponent(m),{responseType:"json",headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(d).error(d)},logout:function(){var a=(new Date).toGMTString();document.cookie="uin=; path=/; expires="+a;document.cookie="skey=; path=/; expires="+a;localStorage.removeItem("login_result")},fetchProfile:function(a){}}}]);angular.module("ts.services.activity",["ts.utils.constants","ts.services.utils","ts.services.user"]).service("ActivityService",["$rootScope","$http","UtilsService","UserService","BACKEND_SERVER",function(b,a,e,k,f){function g(a){a?(b.selectedActivity=a,b.selectedActivityID=a._id):(b.selectedActivity=null,b.selectedActivityID="");console.log("[ActivityService] selected activity",b.selectedActivity)}function m(h,g,k,q){d();g=g||{};g._=(new Date).getTime();g=e.object.toUrlencodedString(g);a.put(f+"/activities/"+
h,g,{responseType:"json",headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(a,d){if(a&&!a.c&&a.r)a:{var h=a.r;b.activityMap[h._id]=h;for(var e=0;e<b.activityList.length;++e)for(var g=b.activityList[e].activities,f=0;f<g.length;++f)if(g[f]._id==h._id){b.selectedActivity==g[f]&&(b.selectedActivity=h,b.selectedActivityID=h._id);g[f]=h;break a}}c();k&&k(a,d)}).error(function(a,b){c();q&&q(a,b)})}function n(a,c){b.activityList.splice(a,0,{date:p(c),activities:[c]})}function p(a){a=
new Date(a.info.date);a.setHours(0);a.setMinutes(0);a.setSeconds(0);a.setMilliseconds(0);return a.getTime().toString()}function d(){r.setAttribute("disabled","disabled")}function c(){r.removeAttribute("disabled")}function l(){b.hints="\u6ca1\u627e\u5230\u4efb\u4f55\u6d3b\u52a8"}var r=document.getElementById("activityDetailButtons");b.activityList=[];b.activityMap={};b.selectedActivity=null;b.selectedActivityID="";b.hints="";return{selectActivity:g,selectActivityByID:function(a){g(b.activityMap[a])},
fetchActivities:function(c,d,e){b.activityList=[];b.activityMap={};b.hints="\u8bf7\u7a0d\u5019...";c=c||{};"manager"==b.mode()&&(c.creator=k.uid());c._=(new Date).getTime();console.log("[ActivityService] fetching activities with",c);a.get(f+"/activities",{responseType:"json",params:c}).success(function(a,c){if(200===c&&!a.c){var e=a.r.activities,h=_.groupBy(e,function(a){return p(a)});b.activityList=_.map(h,function(a,b){return{date:b,activities:a}});b.activityMap=_.reduce(e,function(a,b){a[b._id]=
b;return a},{});b.activityList.length?b.hints="":l();console.log("[ActivityService] activities result",b.activityList,b.activityMap)}d&&d(a,c)}).error(function(a,c){b.hints="\u62c9\u53d6\u6d3b\u52a8\u5931\u8d25";e&&e(a,c)})},getActivity:function(b,c,d){var e=(new Date).getTime();a.get(f+"/activities/"+b+"?_="+e,{responseType:"json"}).success(c).error(d)},createActivity:function(c,d,g){c=c||{};c._=(new Date).getTime();c=e.object.toUrlencodedString(c);a.post(f+"/activities",c,{responseType:"json",headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(a,
c){if(a&&!a.c&&a.r){b.hints="";a:{var e=a.r[0];b.activityMap[e._id]=e;for(var g=p(e),h=0;h<b.activityList.length;++h){var f=b.activityList[h];if(f.date==g){f.activities.unshift(e);break a}else if(f.date>g){n(h,e);break a}}n(h,e)}}b.hints="";d&&d(a,c)}).error(g)},updateActivity:m,closeActivity:function(a,b,c){m(a,{status:"closed"},b,c)},deleteActivity:function(e,k,m){d();a({method:"DELETE",url:f+"/activities/"+e+"?_="+(new Date).getTime()}).success(function(a,d){if(a&&!a.c)a:{g(),delete b.activityMap[e];
for(var f=0;f<b.activityList.length;++f)for(var m=0;m<b.activityList[f].activities.length;++m)if(b.activityList[f].activities[m]._id==e){b.activityList[f].activities.splice(m,1);b.activityList[f].activities.length||b.activityList.splice(f,1);break a}}c();b.activityList.length||l();k&&k(a,d)}).error(function(a,b){c();m&&m(a,b)})},fetchActivityConfig:function(b,c){var d=(new Date).getTime();a.get(f+"/activities/config?_="+d,null,{responseType:"json"}).success(function(a,c){console.log("[ActivityService] activity config =",
a);b&&b(a,c)}).error(function(a,b){console.error("[ActivityService] FAIL TO FETCH ACTIVITY CONFIGURATIONS");c&&c(a,b)})}}}]);angular.module("ts.controllers.activityDetail",["ts.utils.constants","ts.services.activity"]).controller("ActivityDetailController",["$rootScope","$scope","ActivityService","EVENT_MODE_CHANGE","CMD_SHOW_ACTIVITY_PANEL",function(b,a,e,k,f){a.userCount=function(){if(b.selectedActivity){if(b.selectedActivity.active)return b.selectedActivity.users.participators.length;var a=_.countBy(b.selectedActivity.resources,function(a){return a.user});return _.keys(a).length}return 0};a.editActivity=function(){b.$emit(f,
