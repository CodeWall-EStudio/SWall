package com.swall.tra_qq.utils;
...
import com.swall.tra_qq.network.ActionService;
...
public class NetworkUtils {
    ...
    public static class MultipartRequest extends Request<String> {
        ...
        public MultipartRequest(String url,String activityId,String encodeKey,byte[] data, File file,ContentType contentType,Response.Listener<String> listener, Response.ErrorListener errorListener){
            ...
            builder.addTextBody("activityId",activityId);
