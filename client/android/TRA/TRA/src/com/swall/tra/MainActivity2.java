...
import com.swall.tra2.CurrentTRAActivity3;
 ...
 */
public class MainActivity2 extends BaseFragmentActivity  implements TabHost.TabContentFactory,  TabHost.OnTabChangeListener {
    ...
    private void initTabs() {
        ...
        mTabHost.addTab(getTabSpec(ExpiredActivitiesActivity2.class,R.string.tab_expired_activities));
