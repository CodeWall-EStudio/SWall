...
import com.codewalle.tra.BaseFragmentActivity;
import com.codewalle.tra.Model.TRAInfo;
import com.codewalle.tra.R;
import com.codewalle.tra.TRAApplication;
...
public class ActivitiesListAdapter extends BaseAdapter {
    ...
    public void setJSONData(JsonObject sourceObject){
        // TODO 暂时适配旧代码
        try {
            JSONObject object = new JSONObject(sourceObject.toString());
            setJSONData(object);
    ...
    public void setJSONData(JSONObject sourceObject) {
        ...
        infos.clear();
        String currentAccountName = TRAApplication.getApplication().getCachedAccount().userName;
