package com.codewalle.tra.adapter;
...
import com.codewalle.tra.Model.ResourceInfo;
...
//        private final View joined;
        ...
        public ViewHolder(View convertView) {
            ...
            imageView = (ImageView)convertView.findViewById(R.id.item_resource_image);
...
*/
        ...
        public void update(ResourceInfo item) {
            ...
            if(item.type  == ResourceInfo.RESOURCE_TYPE_TEXT){
                textView.setVisibility(View.VISIBLE);
                imageView.setVisibility(View.GONE);
                commentTextView.setVisibility(View.GONE);
                textView.setText(item.content);
            }else if(item.type == ResourceInfo.RESOURCE_TYPE_IMAGE){
                if(!TextUtils.isEmpty(item.content) && item.content.startsWith("http")){
                    textView.setVisibility(View.GONE);
                    imageView.setVisibility(View.VISIBLE);
                    commentTextView.setVisibility(View.VISIBLE);
                    Log.i("AAA","loadimage:"+item.content);
                    Ion.with(imageView)
            ...
            }else if(item.type == ResourceInfo.RESOURCE_TYPE_AUDIO){
                textView.setVisibility(View.VISIBLE);
                imageView.setVisibility(View.GONE);
                commentTextView.setVisibility(View.GONE);
